    ...
    public class clsSocialLinkDA : ISocialLink
    {
        ...
        public async Task<bool> updateById(SocialLinkDTO socialLink)
        {
            try
            {
                ...
                await using var command = new NpgsqlCommand("SELECT * FROM updateSocialLinkById(@p_id, @p_platform, @p_url, @p_icon, @p_personid)", connection);
        ...
        public async Task<bool> deleteById(long ID)
        {
            try
            {
                ...
                await using var command = new NpgsqlCommand("SELECT * FROM deleteSocialLinkById(@p_id)", connection);
                command.Parameters.AddWithValue("@p_id", ID);
